This is the pre-calculated dataset using 101 Polycyclic Aromatic Hydrocarbons.
...
The end-to-end scripts to load the dataset, performing SISSO training, and post-processing are stored in GitHub Repository: https://github.com/siyu-g/SISSOonPAH/
